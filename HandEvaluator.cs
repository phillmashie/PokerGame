...
namespace PokerGame
{
    ...
    class HandEvaluator : Card
    {
        ...
        public Hand EvaluateHand()
        {
            ...
            //if the hand is nothing, then the palyer with the highest card wins
        ...
        {
            //if the first 4 cards, add value of the four cards and last card is the highest
        ...
        private bool Flush()
        {
            ...
            if(heartsSum == 5 || diamondSum == 5 || spadesSum == 5)
            {
                //the player with higher card win
        ...
        private bool TwoPairs()
        {
            ...
            //if 1, 2, and 4, 5
            // if 2, 3 and 4,5
            // with two pairs , the 2nd card will always be part of one pair
            ...
            else if (cards[0].MyValue == cards[1].MyValue && cards[2].MyValue == cards[3].MyValue)
            {
                handValue.Total = ((int)cards[1].MyValue * 2) + ((int)cards[3].MyValue * 2);
